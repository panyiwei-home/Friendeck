...
- [Friendeck - Steam Deck 文件管理助手](#friendeck---steam-deck-文件管理助手)
  - [目录](#目录)
  - [截图预览](#截图预览)
  - [功能特点](#功能特点)
  - [先决条件](#先决条件)
...
- **媒体管理** - 新增媒体管理标签页，集中浏览 Steam Deck 截图与视频，支持多选并批量下载到本地。
...
1. 从 [Releases](https://github.com/panyiwei-home/Friendeck/releases) 页面下载最新的插件 ZIP 文件。
