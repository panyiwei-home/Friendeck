  ...
  "zh-CN": {
    translation: {
      ...
      toasts: {
        ...
        preventSleepFailedBody: "无法更新防休眠设置",
      ...
      transferSettings: {
        ...
        file: {
          ...
          preventSleepLabel: "下载时设备不休眠",
          preventSleepDesc: "传输文件期间阻止系统进入休眠",
  ...
  "en-US": {
    translation: {
      ...
      toasts: {
        ...
        preventSleepFailedBody: "Unable to update sleep prevention setting",
      ...
      transferSettings: {
        ...
        file: {
          ...
          preventSleepLabel: "Keep Device Awake While Downloading",
          preventSleepDesc: "Prevent system sleep during file transfers",
